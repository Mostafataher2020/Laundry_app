...
class _AddressIdentificationBodyState extends State<MyLocation> {
  bool isVilla = false;
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: isPortrait ? 20 : screenWidth * 0.2,),
                  child: CustomButton(
                    text: context.tr('Add New Location'),
                    buttonAction: () {
                      // Navigator.push(context, MaterialPageRoute(builder: (context) => HomeScreen()));
                    }, color: Color(0xFFF84BEE1), width: screenWidth * 0.75,
                  ),
                ),
